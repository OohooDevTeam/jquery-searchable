(function( $ ) {
    $.fn.searchable = function( options ) {
        //Get the settings for this searchable object.
        /**
         * bar_location:        [top, bottom]
         * background-color:    [css]
         * searchable_class:    [all or classname]
         * search_label:        [String]
         * type:                [html, attr, function]
         * searchable_attr:     [attr name]
         * searchable_fucntion: [function(seachable_element) {}]
         */
        var settings = $.extend({
            'bar_location'      :   'top',
            ...
            'search_label'      :   'Search:',
            'type'              :   'html',
            'searchable_attr'   :   'tags',
            'height'            :   '347px', //Makes my life easier.. Proabbly a useful default to you.
            'searchable_funtion':   function(element) {
                return element.html();
            }
        }, options);
